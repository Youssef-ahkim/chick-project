...
function Navbar() {
    return (
        <header className="fixed top-0 z-50 w-full px-4 md:px-8 py-6 flex justify-center pointer-events-none">
            <nav className="container max-w-6xl mx-auto glass rounded-[2rem] pointer-events-auto" style={{ transform: 'translateZ(0)' }}>
