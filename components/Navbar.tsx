...
function Navbar() {
    return (
        <header className="fixed top-0 z-50 w-full px-4 md:px-8 lg:px-12 py-6 flex justify-center pointer-events-none">
            <nav className="container mx-auto glass rounded-3xl pointer-events-auto" style={{ transform: 'translateZ(0)' }}>
