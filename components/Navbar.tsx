            ...
            <nav className="max-w-[1536px] w-full glass rounded-3xl pointer-events-auto" style={{ transform: 'translateZ(0)' }}>
                <div className="flex justify-between items-center px-4 md:px-8 py-3">
                    ...
                    <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600">
                        <Link href="/products" className="hover:text-orange-600 transition-colors focus:text-orange-600">Products</Link>
                        <Link href="#" className="hover:text-orange-600 transition-colors focus:text-orange-600">Farm Story</Link>
                        <Link href="#" className="hover:text-orange-600 transition-colors focus:text-orange-600">Quality</Link>
